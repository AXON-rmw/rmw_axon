...
pub struct ClientConfig {
    /// Optional TLS 1.3 external PSK. This selects PSK-only key establishment.
    pub external_psk: Option<crate::external_psk::ExternalPsk>,
...
impl ClientConfig {
    ...
    pub(super) fn needs_key_share(&self) -> bool {
        self.external_psk.is_none() && self.supports_version(ProtocolVersion::TLSv1_3)
    }
